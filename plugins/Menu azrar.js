...
const handler = async (m, {conn, usedPrefix, usedPrefix: _p, __dirname, text, isPrems}) => {
  ...
  const zack = 'https://i.ibb.co/QD7DHB0/e71dc87506f9.jpg'
  const mentionId = m.key.participant || m.key.remoteJid;
 
conn.relayMessage(m.chat, { viewOnceMessage: { message: { interactiveMessage: { header: { title: `harley`}, body: { text: `˼⚕️˹↜ مـࢪحـبـا بـك/ي @${mentionId.split('@')[0]}
> ˼🪪˹↜ مــعــلــومــاتــك ↶
╮───────────────────⟢ـ
...
> © 𝐍𝐀𝐑𝐔𝐓𝐎 & 𝐙𝐀𝐂𝐊 2025`,subtitle: "Araab Zack",},header: { hasMediaAttachment: true,...(await prepareWAMessageMedia({ image : { url: zack } }, { upload: conn.waUploadToServer }, {quoted: m}))},
                        ...
                        isForwarded: false,
...

                            {
                                ...
                                buttonParamsJson: JSON.stringify({
                                    ...
                                    sections: [
                                        {
                                            title: 'مــرحـ✅️ـبــا بــك فـي مــ☑هــام لينو بـ⚕️ـوت',
                                            highlight_label: 'Dazai🖤',
                                            rows: [
                                                {
                  ...
                  messageParamsJson: ''
                     ...
                     {
               name: "cta_url",
               buttonParamsJson: '{"display_text":"⌈🖤╎قـنـاة الــبــوت╎🖤⌋","url":"https://whatsapp.com/channel/0029VaoUBmSKmCPIIiEatx1H","merchant_url":"https://whatsapp.com/channel/0029VapxAcz4SpkEe0XN6X3V"}'
                            }
                        ]
                    }
                }
